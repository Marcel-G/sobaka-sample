<script lang="ts">
	import { Input, Oscillator, OscillatorState, OscillatorWave, Parameter, SamplerNode } from "sobaka-sample-web-audio";
  ...
  export let context: SamplerNode;
	...
	const loading = Promise.all([
		...
		.then(([oscillator_id, frequency_id]) => {
			modules.register(id, {
